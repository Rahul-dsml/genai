...
def verify_access_token(token: str):
    ...
    try:
        payload = jwt.decode(token, os.getenv('JWT_SECRET_KEY'), algorithms=[os.getenv('JWT_TOKEN_ALGORITHM')])
        ...
        print("JWT Error Occured:", e)
        raise credentials_exception
    except Exception as e:
        print("Unexpected Error occured in Verify_access_token: ", e)
        raise credentials_exception
    return token_data
